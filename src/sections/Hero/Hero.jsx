...
import heroImg from '../../assets/ST.png';
...
import CV from '../../assets/ST_CV.pdf';
    ...
    <section id="hero" className={styles.container}>
      <div className={styles.colorModeContainer}>
        <img
          ...
          alt="Profile picture of Sahan Thejana"
        />
        <img
      ...
      <div className={styles.info}>
        ...
        <h2><span style={{ fontWeight: 'bold' }}>I&apos;am</span>
          <span>
            <span style={{ color: '#fa8f03', margin: '0 -30px' }}>
              {text}
        ...
        <span>
          ...
          <a href="https://github.com/s2003tt" target="_blank">
